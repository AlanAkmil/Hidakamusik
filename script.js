...
async function openUserProfile(uid){
  ...
  try{
    ...
    document.getElementById('profileRoleText').textContent=_getProfileRole(cc);
...
function setCoins(v){localStorage.setItem('hidaka_coins',String(Math.max(0,v)));_refreshCoinUI();}
